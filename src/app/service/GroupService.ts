...
export class GroupService extends AbstractService{//implements SearchableService<GroupSearchParams, GroupMainDto> {
	url: string = "http://localhost:8080/rest/api/group/";
